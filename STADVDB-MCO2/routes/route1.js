...
const slave1Config = { ...masterConfig, host:'10.2.0.82', database: 'mco2slave1'}; //database names
const slave2Config = { ...masterConfig, host:'10.2.0.83', database: 'mco2slave2'}; //database names
